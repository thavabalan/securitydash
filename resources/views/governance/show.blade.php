                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                              <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                @foreach ($governance->requirements as $requirement)
                                <tr>
                                <td>{{$requirement->category->name}}</td>
                                <td>@foreach($requirement->concepts as $item){{$item->name}}@endforeach</td>
                                <td>@foreach($requirement->governance as $item){{$item->name}}@endforeach</td>
